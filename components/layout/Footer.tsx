    ...
    <footer className="w-full relative mt-16 sm:mt-24">
      ...
      <div className="relative bg-gradient-to-b from-surface-container-high via-surface-container to-surface-container-high text-on-surface overflow-hidden">
        ...
        <div className="relative z-10 section-container pt-14 pb-8 sm:pt-20 sm:pb-12">
                    ...
                    {[
                      {
                        ...
                        label: "Facebook",
                        href: "https://facebook.com/yamgurumi",
                      },
                      {
                        icon: <FaInstagram className="w-4 h-4" />,
                        label: "Instagram",
                        href: "https://instagram.com/yamgurumi",
                      },
                      {
                        icon: <FaTiktok className="w-4 h-4" />,
                        label: "TikTok",
                        href: "https://tiktok.com/@yamgurumi",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        label: "Email",
                        href: "mailto:contacto@yamgurumi.com",
                      },
                    ].map((item) => (
                      <a
                        key={item.label}
          ...
          {/* Large Brand Watermark Typographic Banner Vectorial Adaptativo */}
          <div className="max-w-7xl mx-auto mt-12 sm:mt-16 pt-8 border-t border-primary-container/15 w-full overflow-hidden text-center pointer-events-none select-none flex justify-center items-center">
            <svg
            ...
            >
              <text
                ...
                fontWeight="900"
                letterSpacing="4"
                className="font-headline font-black uppercase fill-on-surface/5"
              >
                Yamgurumi
              </text>
            </svg>
