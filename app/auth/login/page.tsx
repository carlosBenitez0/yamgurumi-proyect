...
import { MdArrowBack, MdCheckCircle, MdErrorOutline, MdOutlineEmail, MdOutlineLock, MdAutoAwesome } from 'react-icons/md';
...
function LoginFormContent() {
  ...
  return (
    <div className="w-full max-w-6xl xl:max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-12 items-center z-10 relative my-auto py-8 sm:py-12">
      ...
      <div className="lg:col-span-6 xl:col-span-5 w-full flex justify-center order-1">
        <div className="relative w-full bg-surface-container-lowest p-8 sm:p-10 rounded-[2.5rem] shadow-card border border-primary-container/20 transition-all duration-300 hover:shadow-elevation">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 font-body" noValidate>
            ...
            >
              <span className="relative z-10">{isPending ? 'Entrando...' : state?.success ? 'Redirigiendo...' : 'Iniciar Sesión'}</span>
            </button>
          </form>
      ...
      {/* Columna Derecha: Showcase Panel (Modelo 3D + Ventajas apilados) */}
      <div className="lg:col-span-6 xl:col-span-7 w-full order-2">
