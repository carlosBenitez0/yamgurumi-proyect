              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-2">
                ...
                >
                  {addedToCart ? (
                    ...
                    <>
                      <MdShoppingBag className="text-[18px] flex-shrink-0" />
                      Agregar a la bolsa
                    </>
                  )}
                </button>
                ...
                <Link
                  ...
                  className="min-w-0 flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl font-body text-sm font-bold whitespace-nowrap bg-whatsapp text-white hover:bg-whatsapp-hover transition-all duration-300 active:scale-[0.97] shadow-button hover:shadow-elevation"
                >
