...
async function main() {
  ...
  console.log('⚙️ Configuraciones de tienda sembradas con WhatsApp +503 7731 1064.');

  // 6. Inyección de Pedidos con Número de WhatsApp Unificado (+503 7731 1064)
  const sampleOrders = [
    {
      id: 'ORD-8490',
  ...
  console.log(`📦 Se han actualizado 15 pedidos reales con el número de WhatsApp +503 7731 1064.`);
